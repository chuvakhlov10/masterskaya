...
if (!source.includes(importMarker)) throw new Error("Secure Ably import marker not found");
...
if (!source.includes(realtimeMarker)) throw new Error("Ably realtime marker not found");
source = source.replace(realtimeMarker, `${realtimeMarker}\ninstallStorageGatewayProbe();`);
